...
export default function Operation( {addTransaction, addDescription, addAmouth,description,amount}) {
  return (
    ...
    <form id="form">
        ...
        <div className="operation__btns">
            <button onClick={() => addTransaction(false)} type="button" 
            className="operation__btn operation__btn-subtract">РАСХОД</button>
            <button onClick={() => addTransaction(true)} type="button" 
